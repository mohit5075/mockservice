...
data class SaleDDCAPResponse(
    @JsonProperty("success") val success: Boolean,
    @JsonProperty("message") val message: String,
    @JsonProperty("errorCode") val errorCode: String,
    @JsonProperty("Status") val Status: String,
    @JsonProperty("data") val data: SaleDDCAPResponseData
)

// Controller for SaleDDCAP
@RestController
class ControllerSaleDDCap {

    @PostMapping("/saleddcap")
    fun handleRequest(@RequestBody request: SaleDDCAPRequest): SaleDDCAPResponse {
        return SaleDDCAPResponse(
            success = true,
            message = "",
            errorCode = "ER-00",
            Status = "",
            data = SaleDDCAPResponseData(
                tran_currency = "SAR",
                tran_bcdt_code = "ALPHA_CLIENT_FINANCING_API_DDC",
                tran_settlement_date = "16 Jan 2024",
                tran_original_maturity_date = "17 Jan 2024",
                tran_deferred_price = 0.0,
                tran_extra_reference2 = "",
                tran_input_timestamp = "15 Jan 2024 16:34:32",
                tran_original_key = "ALPHA_2152512_000001",
                tran_next_stage = "COMPLETED",
                tran_extra_reference1 = "",
                documents_uri = "https://afp.ddcap.com/api/deals/ALPHA_2152512_000002/documents/",
                tran_original_trade_date = "15 Jan 2024",
                tran_fee_usd = "0.00",
                ...
                tran_price = 3750.0,
                tran_class = "STANDARD",
                transaction_key = "ALPHA_2152512_000002",
                tran_client_name = "Client",
                tran_trade_date = "15 Jan 2024",
                tenor = "1",
                sub_transaction_no = "2",
                tran_stage_code = "ALPHA_STAGE3",
                tran_fee_exchange_rate = "0.00000000",
                tran_maturity_date = "17 Jan 2024",
                ...
                tran_your_reference = "15-01-2024 16:34:21",
                tran_branch = "",
                tran_exchange_rate = "3.75000000 SAR = 1 USD ",
                tran_fee_currency = "",
                tran_original_settlement_date = "16 Jan 2024",
                tran_quantity = 4.0,
                tran_outstanding_quantity = 0.0,
                principal_plus_comm = "0.00",
                original_deal_uri = "https://afp.ddcap.com/api/deals/ALPHA_2152512_000001",
                uri = "https://afp.ddcap.com/api/deals/ALPHA_2152512_000002",
                tran_outstanding_principal = 0.0,
                tran_comdty_alloc_number = "65186 2152512 PDZ",
                tran_fee = "0",
                location_rule = "In vault, Zurich",
                tran_tre_type = "Sell-Off",
