...
// Request Data Class
data class ConfirmPurchaseDDCAPRequest(
    @JsonProperty("tran_stage_code")
...
data class ConfirmPurchaseDDCAPResponseData(
    ...
    @JsonProperty("tran_exchange_rate")
    val tran_exchange_rate: String,

    @JsonProperty("tran_fee_currency")
    val tran_fee_currency: String,

    @JsonProperty("tran_original_settlement_date")
    val tran_original_settlement_date: String,

    @JsonProperty("tran_quantity")
    val tran_quantity: Double,

    @JsonProperty("tran_outstanding_quantity")
    val tran_outstanding_quantity: Double,

    @JsonProperty("principal_plus_comm")
    val principal_plus_comm: String,

    @JsonProperty("original_deal_uri")
    val original_deal_uri: String,

    @JsonProperty("uri")
    val uri: String,

    @JsonProperty("tran_outstanding_principal")
    val tran_outstanding_principal: Double,

    @JsonProperty("tran_comdty_alloc_number")
    val tran_comdty_alloc_number: String,

    @JsonProperty("tran_fee")
    val tran_fee: String,

    @JsonProperty("location_rule")
    val location_rule: String,

    @JsonProperty("tran_tre_type")
    val tran_tre_type: String,

    @JsonProperty("tran_deal_type")
    val tran_deal_type: String,

    @JsonProperty("tran_total_quantity")
    val tran_total_quantity: Double
)

data class ConfirmPurchaseDDCAPResponse(
    ...
    @JsonProperty("data")
    val data: ConfirmPurchaseDDCAPResponseData
)

// Controller for ConfirmPurchaseDDCAP
@RestController
class ControllerConfirmPurchaseDDCap {

    @PostMapping("/confirmpurchaseddcap")
    fun handleRequest(@RequestBody request: ConfirmPurchaseDDCAPRequest): ConfirmPurchaseDDCAPResponse {
        return ConfirmPurchaseDDCAPResponse(
            success = true,
            message = "",
            errorCode = "ER-00",
            Status = "",
            data = ConfirmPurchaseDDCAPResponseData(
                tran_currency = "SAR",
